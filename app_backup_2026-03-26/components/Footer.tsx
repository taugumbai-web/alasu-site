...
import { Lang, INSTAGRAM, navLinks, catalogSubs, IgIcon, TelegramIcon, TikTokIcon, WhatsAppIcon } from "./shared";
...
export default function Footer({ lang }: { lang: Lang }) {
    ...
    const footerLinks = navLinks.filter(l => l.href !== "/");
    ...
    return (
        <footer className="relative bg-[#010611] border-t border-white/[0.03] pt-20 pb-12 z-40 overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-14 md:gap-10 items-start mb-16">
                    ...
                    <div className="md:col-span-4 flex flex-col items-start">
                        <Link href="/" className="inline-block no-underline group mb-3">
                            <div className="text-4xl font-black tracking-[0.2em] text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-blue-400 transition-all duration-500">
                                ALASU
                            </div>
                        </Link>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none select-none -z-10">
                <span className="text-[25vw] font-black tracking-tight text-white/[0.013] whitespace-nowrap leading-none">
                    ALASU
                </span>
            </div>
        </footer>
