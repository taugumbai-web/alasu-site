...
const PRODUCTS = [
    ...
    },
    {
        ...
        label: { ru: "Энергетик", kz: "Энергетик", en: "Energy", zh: "能量饮料" },
        ...
        <>
            ...
            {preloader && (
                <div className={`fixed inset-0 z-[999] flex flex-col items-center justify-center bg-[#010c1f] ${preOut ? "pre-out" : ""}`}>
                    ...
                    <p className="pre-logo relative z-10 mt-8 text-white font-black uppercase select-none" style={{ fontSize: "clamp(1.4rem,4vw,2.2rem)", letterSpacing: "0.35em" }}>ALASU</p>
            ...
            <div style={{
                ...
                <div className="absolute top-20 right-5 sm:right-8 md:right-12 pointer-events-none select-none text-right"
                    style={{ opacity: heroVisible ? 1 : 0, transition: "opacity 0.6s ease" }}>
                    <div className="flex items-center justify-end gap-2 mb-1">
                        <span className="text-[9px] tracking-[0.3em] uppercase text-blue-400/60 font-bold">GPS</span>
                        <div className="hud-dot w-1.5 h-1.5 rounded-full bg-cyan-400" style={{ boxShadow: "0 0 8px rgba(34,211,238,0.9)", animationDelay: "0.7s" }} />
                    </div>
                    <div className="text-white/40 font-mono leading-tight text-[10px] sm:text-xs">
                        <div>42°01′N</div>
                        <div>80°11′E</div>
                    </div>
                </div>
                ...
                <div className="relative z-20 flex h-full flex-col items-center justify-center text-center px-4 sm:px-6 pb-28">
                    <div key={slideIdx} className="slide-text flex flex-col items-center">
                        ...
                        {/* title */}
                        <h1 className="font-black leading-none uppercase text-white drop-shadow-2xl"
                            style={{
