...
const products: Product[] = [
    ...
    {
        img: "/энергетики/аласу силвер.jpeg",
...
export default function EnergyPage() {
    return (
        <CatalogTemplate
            products={products}
            category="energy"
            titleRu="Напиток Энергетик"
            titleKz="Энергетикалық сусын"
            titleEn="Energy Drink"
            titleZh="能量饮料"
            descRu="Энергетические напитки на чистой горной воде Хан Тэнгри — сила природы в каждом глотке."
